...
export function CheckSolutionModal({
          ...
          <div className="flex flex-col bg-c-dark1 text-white items-center justify-center py-[20px] px-[10px] rounded-[10px] border-2 border-c-purple gap-[5px]">
            ...
            <div className="flex gap-[25px]">
              <div className="flex flex-col items-center mb-[5px]">
                <div className="text-[14px] leading-[100%] mb-[5px]">Player:</div>
                <input
                  type="text"
                  value={name}
                  placeholder="You"
              ...
              <div className="flex flex-col items-center">
                <div className="text-[14px] leading-[100%] mb-[5px]">Solved in:</div>
            ...
            <div className="flex gap-[10px]">
              ...
              <div
                ...
                className={cx(
                  ...
                  {
                    'active:bg-red-700 shadow-button-back': typeof added === 'string',
              ...
              >
                {!loading && added === false ? (
                  ...
                  <SVG path="spinner" fill="#ffffff" w={25} h={25} className="animate-spin text-center" />
                ) : added === 'error' ? (
                  'Error adding :('
                ) : added === 'too slow' ? (
                  'Too slow :('
  ...
  if (retry) {
    return (
      <div className="absolute text-red-700 z-[100] bottom-[10px] bg-c-dark2 p-[5px] font-semibold rounded-[10px] shadow-button-back">
        Solution is WRONG
      </div>
    )
  }
  ...
  return (
    <div
      className="absolute text-white z-[100] bottom-[10px] border border-c-purple p-[5px] rounded-[10px] bg-c-dark2 active:bg-c-purple cursor-pointer"
      onClick={() =>
        setTimeout(() => {
          checkSolution(time)
        }, 100)
